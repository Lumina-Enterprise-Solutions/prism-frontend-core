...
import { DecorativeAccent } from "../../ui/decoration-spacing"
        ...
        <AnimatePresence>
            {isLoading && (
                <motion.div
                    ...
                    className={cn("fixed inset-0 z-50 flex flex-col items-center justify-center", backgroundClass, className)}
                >
                    {/* Decorative elements */}
                    {showDecorations && (
                        <>
                            ...
                            >
                                <DecorativeAccent variant="circle" color="primary" className="w-8 h-8" />
                            </motion.div>
                            ...
                            >
                                <DecorativeAccent variant="square" color="secondary" className="w-8 h-8" />
                            </motion.div>
                    ...
                    <div className="relative flex flex-col items-center">
                        ...
                        >
                            ...
                            >
                                <Logo variant={logoVariant} darkMode={isDark} className="h-full w-full" />
                            </motion.div>
                        </motion.div>
...
export function LoadingSpinner({
    ...
    return (
        <div className={cn("flex items-center justify-center", className)}>
            <motion.div
                className={cn("border-t-transparent rounded-full border-primary", sizeClass)}
