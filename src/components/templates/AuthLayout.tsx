  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2 bg-background dark:bg-foreground">
      <div className="relative hidden bg-muted lg:block">
        ...
        />
        <div className="absolute inset-0 flex flex-col items-start justify-start bg-foreground/50 dark:bg-foreground/10 p-10">
          <div className="mt-10">
        ...
        <motion.div variants={itemVariants} className="absolute inset-0 flex flex-col items-start justify-center p-10 space-y-2">
          {[
            ...
            >
              <div className="bg-primary/50 backdrop-blur-sm text-primary-foreground dark:text-foreground p-2 rounded-full">
              ...
              <span className="font-medium text-primary-foreground dark:text-foreground">{item.text}</span>
            </motion.div>
          ))}
        </motion.div>
        <motion.div variants={itemVariants} className="absolute inset-0 flex flex-col items-start justify-end p-10 text-sm text-primary-foreground dark:text-foreground">
